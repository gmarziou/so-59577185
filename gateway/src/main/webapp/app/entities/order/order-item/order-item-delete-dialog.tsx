...
export const OrderItemDeleteDialog = (props: IOrderItemDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.orderOrderItem.delete.question">
        <Translate contentKey="gatewayApp.orderOrderItem.delete.question" interpolate={{ id: orderItemEntity.id }}>
