...
import { getEntities as getProducts } from 'app/entities/order/product/product.reducer';
import { IProductOrder } from 'app/shared/model/order/product-order.model';
import { getEntities as getProductOrders } from 'app/entities/order/product-order/product-order.reducer';
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.orderOrderItem.home.createOrEditLabel">
            <Translate contentKey="gatewayApp.orderOrderItem.home.createOrEditLabel">Create or edit a OrderItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : orderItemEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="order-item-product" type="select" className="form-control" name="productId" required>
                  {products
              ...
              <AvGroup>
                ...
                <AvInput id="order-item-order" type="select" className="form-control" name="orderId" required>
                  {productOrders
