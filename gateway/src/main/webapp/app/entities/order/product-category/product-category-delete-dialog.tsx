...
export const ProductCategoryDeleteDialog = (props: IProductCategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.orderProductCategory.delete.question">
        <Translate contentKey="gatewayApp.orderProductCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
