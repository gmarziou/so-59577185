...
const apiUrl = 'services/order/api/product-categories';
const apiSearchUrl = 'services/order/api/_search/product-categories';

// Actions

export const getSearchEntities: ICrudSearchAction<IProductCategory> = (query, page, size, sort) => ({
