...
export const ProductOrderDeleteDialog = (props: IProductOrderDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.orderProductOrder.delete.question">
        <Translate contentKey="gatewayApp.orderProductOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
