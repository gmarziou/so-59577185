...
import { getSearchEntities, getEntities } from './product-order.reducer';
  ...
  return (
    <div>
      <h2 id="product-order-heading">
        <Translate contentKey="gatewayApp.orderProductOrder.home.title">Product Orders</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="gatewayApp.orderProductOrder.home.createLabel">Create new Product Order</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('gatewayApp.orderProductOrder.home.search')}
                />
      ...
      <div className="table-responsive">
        {productOrderList && productOrderList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('placedDate')}>
                  <Translate contentKey="gatewayApp.orderProductOrder.placedDate">Placed Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="gatewayApp.orderProductOrder.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="gatewayApp.orderProductOrder.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('invoiceId')}>
                  <Translate contentKey="gatewayApp.orderProductOrder.invoiceId">Invoice Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="gatewayApp.orderProductOrder.home.notFound">No Product Orders found</Translate>
          </div>
        )}
      </div>
