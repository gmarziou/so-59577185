...
import { getEntities as getProductCategories } from 'app/entities/order/product-category/product-category.reducer';
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.orderProduct.home.createOrEditLabel">
            <Translate contentKey="gatewayApp.orderProduct.home.createOrEditLabel">Create or edit a Product</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : productEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="product-name">
                  <Translate contentKey="gatewayApp.orderProduct.name">Name</Translate>
                </Label>
                <AvField
                  id="product-name"
                  type="text"
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="product-description">
                  <Translate contentKey="gatewayApp.orderProduct.description">Description</Translate>
                </Label>
                <AvField id="product-description" type="text" name="description" />
              </AvGroup>
              <AvGroup>
                <Label id="priceLabel" for="product-price">
                  <Translate contentKey="gatewayApp.orderProduct.price">Price</Translate>
                </Label>
                <AvField
                  id="product-price"
                  type="text"
              ...
              <AvGroup>
                <Label id="sizeLabel" for="product-size">
                  <Translate contentKey="gatewayApp.orderProduct.size">Size</Translate>
                </Label>
              ...
              <AvGroup>
                <AvGroup>
                  <Label id="imageLabel" for="image">
                    <Translate contentKey="gatewayApp.orderProduct.image">Image</Translate>
                  </Label>
                  <br />
                  {image ? (
                    <div>
              ...
              <AvGroup>
                <Label for="product-productCategory">
                  <Translate contentKey="gatewayApp.orderProduct.productCategory">Product Category</Translate>
                </Label>
