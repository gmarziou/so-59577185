...
import { IProduct, defaultValue } from 'app/shared/model/order/product.model';
...
const apiUrl = 'services/order/api/products';
const apiSearchUrl = 'services/order/api/_search/products';
