...
describe('Customer e2e test', () => {
  ...
  it('should load create Customer page', async () => {
    ...
    expect(await customerUpdatePage.getPageTitle().getAttribute('id')).to.match(/gatewayApp.customer.home.createOrEditLabel/);
  ...
  /*  it('should delete last Customer', async () => {
        ...
        expect(await customerDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/gatewayApp.customer.delete.question/);
