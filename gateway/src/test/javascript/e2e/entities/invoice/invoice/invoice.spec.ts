...
describe('Invoice e2e test', () => {
  ...
  it('should load create Invoice page', async () => {
    ...
    expect(await invoiceUpdatePage.getPageTitle().getAttribute('id')).to.match(/gatewayApp.invoiceInvoice.home.createOrEditLabel/);
  ...
  it('should delete last Invoice', async () => {
    ...
    expect(await invoiceDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/gatewayApp.invoiceInvoice.delete.question/);
