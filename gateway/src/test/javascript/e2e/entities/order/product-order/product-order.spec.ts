...
describe('ProductOrder e2e test', () => {
  ...
  it('should load create ProductOrder page', async () => {
    ...
    expect(await productOrderUpdatePage.getPageTitle().getAttribute('id')).to.match(/gatewayApp.orderProductOrder.home.createOrEditLabel/);
  ...
  it('should delete last ProductOrder', async () => {
    ...
    expect(await productOrderDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/gatewayApp.orderProductOrder.delete.question/);
