...
describe('Product e2e test', () => {
  ...
  it('should load create Product page', async () => {
    ...
    expect(await productUpdatePage.getPageTitle().getAttribute('id')).to.match(/gatewayApp.orderProduct.home.createOrEditLabel/);
  ...
  it('should delete last Product', async () => {
    ...
    expect(await productDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/gatewayApp.orderProduct.delete.question/);
