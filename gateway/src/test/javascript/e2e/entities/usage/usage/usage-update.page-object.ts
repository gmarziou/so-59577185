...
export default class UsageUpdatePage {
  pageTitle: ElementFinder = element(by.id('gatewayApp.usageUsage.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  dateInput: ElementFinder = element(by.css('input#usage-date'));
  detailsInput: ElementFinder = element(by.css('input#usage-details'));
  sentDateInput: ElementFinder = element(by.css('input#usage-sentDate'));
  userIdInput: ElementFinder = element(by.css('input#usage-userId'));
  productIdInput: ElementFinder = element(by.css('input#usage-productId'));
