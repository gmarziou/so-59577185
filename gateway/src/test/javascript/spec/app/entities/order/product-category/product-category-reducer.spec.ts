...
import { IProductCategory, defaultValue } from 'app/shared/model/order/product-category.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.FETCH_PRODUCTCATEGORY_LIST),
          REQUEST(ACTION_TYPES.SEARCH_PRODUCTCATEGORIES),
          REQUEST(ACTION_TYPES.FETCH_PRODUCTCATEGORY)
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.SEARCH_PRODUCTCATEGORIES),
  ...
  describe('Successes', () => {
    ...
    it('should search all entities', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.SEARCH_PRODUCTCATEGORIES),
          payload
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.SEARCH_PRODUCTCATEGORIES actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.SEARCH_PRODUCTCATEGORIES)
        },
        {
          type: SUCCESS(ACTION_TYPES.SEARCH_PRODUCTCATEGORIES),
          payload: resolvedObject
